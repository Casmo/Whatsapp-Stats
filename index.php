    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-nav">
                <li<?php if ($module == 'wordcloud') { echo ' class="active"'; } ?>><a href="?module=wordcloud">Wordcloud</a></li>
                <li<?php if ($module == 'namecloud') { echo ' class="active"'; } ?>><a href="?module=namecloud">Namecloud</a></li>
                <li<?php if ($module == 'time') { echo ' class="active"'; } ?>><a href="?module=time">Time</a></li>
            </ul>
            <?php
            }
            ?>
